    ...
    <div class="asidebar">
      <aside class="aside">
        ...
        <div class="side">
          ...
          <a href="occasional.html" class="nav-link"><h2>Personalised Jewellery Box</h2></a>
        </div>
      </aside>
    <!-- ============================================================--------------  Bridal section ----------------========================================================= -->

      <div class="bridal">
        <h1>Welcome to Bridal Jewellery Special</h1>

        <div class="bridals">
          
       <div class="bridal1">
        <img src="images/b1.png" alt="" />
        <a href="Bridal1">  <button>Explore Collection</button></a>
