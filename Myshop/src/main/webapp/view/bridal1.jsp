    ...
    <div class="asidebar">
      <aside class="aside">
        ...
        <div class="side">
          ...
          <a href="occasional" class="nav-link"><h2>Occasional</h2></a>
          <a href="occasional" class="nav-link"><h3>Birthday</h3></a>
          <a href="occasional" class="nav-link"><h3>Anniversary</h3></a>
          <a href="occasional" class="nav-link"><h3>Baby Birth</h3></a>
          <a href="occasional" class="nav-link"><h3>Festive Gifts</h3></a>

          <a href="occasional" class="nav-link"><h2>Personalised Jewellery Box</h2></a>
        </div>
      </aside>
      <!-- ============================================================--------------  Bridal section ----------------========================================================= -->

      <div class="bridal">
        <h1>Explore Bridal Section</h1>

        <a href="bridal1"
          ><p>
            Bridal Special > Enchanting | Trendsetter | Dazzling | Elegant
          </p></a
        >
        ...
        <div class="bridals1">
          ...
          <div class="bri1">
            <img src="images/b14" alt="" />
          </div>
          <div class="bri1">
            <img src="images/b15" alt="" />
          </div>
          <div class="bri1">
            <img src="images/b16" alt="" />
          </div>
        </div>
      </div>
    </div>
